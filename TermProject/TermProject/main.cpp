...
int main( int argc, char** argv )
{
    ...
    findContours(thresholded2, contours, heirarchy, CV_RETR_TREE, CV_CHAIN_APPROX_SIMPLE);//FINDING CONTOUR
    ...
    for(int i=0;i<=9;i++)
    {
        ...
        DIR *dir;
        struct dirent *ent;
        char pathToImages[]="/Users/Abhi/Desktop/Abhi/School/Fourth Year/COMP4102/COMP4102-Project/TermProject/TermProject/Images/digits3";
        char path[255];
